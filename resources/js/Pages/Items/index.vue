                    ...
                    <div class="p-6 text-gray-900">
                        <section class="text-gray-600 body-font">
                            <div class="container px-5 py-8 mx-auto">
                                ...
                                >
                                <Link as="button" :href="route('items.create')" class="flex ml-auto text-white bg-yellow-500 border-0 py-2 px-6 focus:outline-none hover:bg-yellow-600 rounded">商品登録</Link>
                                </div>
                                <div
                                    ...
                                    >
                                        ...
                                        <tbody>
                                            ...
                                            >
                                                ...
                                                <td
                                                    class="px-4 py-3 border-b-2 border-gray-200 text-lg text-gray-900"
                                                >
